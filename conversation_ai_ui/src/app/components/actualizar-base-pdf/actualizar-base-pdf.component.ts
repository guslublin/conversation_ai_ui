...
@Component({
  selector: 'app-actualizar-base-pdf',
  templateUrl: './actualizar-base-pdf.component.html',
  styleUrls: ['./actualizar-base-pdf.component.css']
})
export class ActualizarBasePdfComponent implements OnInit {
  ...
  obtener_archivos() {
    this.http.get < string[] > ('http://localhost:8000/obtener_listado_archivos/').subscribe(items => {
      this.items = items;
    });
  }
