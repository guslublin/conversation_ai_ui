...
@Component({
  selector: 'app-conversacion-pdf-cohere',
  templateUrl: './conversacion-pdf-cohere.component.html',
  styleUrls: ['./conversacion-pdf-cohere.component.css']
})
export class ConversacionPdfCohereComponent  implements OnInit {
  ...
  onSubmit(): void {
    ...
    this.http.post('http://localhost:8000/send_pusher_event_cohere/', {
      username: this.user,
      consulta: this.consulta_send
    })
      .subscribe({
        next: (response: any) => {
